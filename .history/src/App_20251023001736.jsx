...
const AppsSection = () => {
    ...
    return (
        <section  id="apps" className="py-16 bg-white text-gray-900">
        <div className="max-w-6xl mx-auto px-6 text-center">
            <h2 className="text-4xl font-bold mb-4">Explore Our Apps</h2>
            ...
            {apps.map((app, index) => (
                <div
                key={index}
                className="flex flex-col items-center bg-gray-50 rounded-2xl shadow-md hover:shadow-lg p-8 transition-all"
                >
                <img
                    src={app.icon}
                    alt={app.name}
                ...
                <p className="text-gray-600 mb-6 text-sm">{app.description}</p>

                {app.comingSoon ? (
                    <span className="text-sm font-semibold bg-yellow-400 text-white py-1 px-4 rounded-full">
                    🚀 Coming Soon
                    </span>
                ) : (
                    ...
                    {app.links.appStore && (
                        ...
                        className="flex justify-center items-center space-x-2 bg-gray-800 text-white py-2 px-4 rounded-lg hover:bg-gray-900 transition-colors"
                        >
                    ...
                    {app.links.googlePlay && (
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex justify-center items-center space-x-2 bg-gray-200 text-gray-800 py-2 px-4 rounded-lg hover:bg-gray-300 transition-colors"
                        >
