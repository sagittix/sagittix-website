...
const AppsSection = () => {
    const apps = [
        ...
        { icon: "icon.png", description: "Discover inner tranquility with guided meditations, relaxing soundscapes, and personal mindfulness journeys.", name: "SadhanaApp", links: { appStore: true, googlePlay: false } }
    ];
