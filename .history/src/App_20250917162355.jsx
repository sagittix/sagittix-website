...
const AppsSection = () => {
    const apps = [
        ...
        { icon: "image_188fec.png", description: "Discover inner tranquility with guided meditations, relaxing soundscapes, and personal mindfulness journeys.", name: "ZenQuest", links: { appStore: true, googlePlay: false } }
    ];
                    ...
                    {apps.map(app => (
                        <div key={app.name} className="bg-white/40 backdrop-blur-lg p-8 rounded-2xl shadow-lg ring-1 ring-black ring-opacity-5 hover:shadow-2xl transition-shadow duration-300 transform hover:-translate-y-2 flex flex-col items-center text-center">
                            ...
                            <div className="flex flex-wrap justify-center gap-3">
                                {app.links.appStore && <a href="#" className="flex items-center space-x-2 bg-gray-800 text-white py-2 px-4 rounded-lg hover:bg-gray-900 transition-colors"><AppleIcon className="w-5 h-5"/><span>App Store</span></a>}
                                {app.links.googlePlay && <a href="#" className="flex items-center space-x-2 bg-gray-200 text-gray-800 py-2 px-4 rounded-lg hover:bg-gray-300 transition-colors"><PlayStoreIcon className="w-5 h-5"/><span>Google Play</span></a>}
                            </div>
                        </div>
                    ))}
                </div>
                ...
                <div className="bg-white/40 backdrop-blur-lg p-8 rounded-2xl shadow-lg ring-1 ring-black ring-opacity-5">
                    <form className="space-y-6">
                        <div>
                            ...
                            <input type="text" id="name" name="name" className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-fuchsia-500 focus:border-transparent transition-colors" />
                        </div>
                        <div>
                            <label htmlFor="email" className="block text-gray-700 font-semibold mb-2">Email</label>
                            <input type="email" id="email" name="email" className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-fuchsia-500 focus:border-transparent transition-colors" />
                        </div>
                        <div>
                            <label htmlFor="message" className="block text-gray-700 font-semibold mb-2">Message</label>
                            <textarea id="message" name="message" rows="4" className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-fuchsia-500 focus:border-transparent transition-colors"></textarea>
                        </div>
